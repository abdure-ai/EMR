...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="flex items-center gap-2">
            <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-brand-500 text-sm font-bold text-white">N</span>
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="text-lg font-semibold text-gray-800 dark:text-white/90">NESIHA</span>
        </a>
    </div>
