...
<div>
    <x-common.page-breadcrumb pageTitle="Edit Medication" />

    <x-common.component-card title="Edit Medication">
        <form wire:submit="save" class="max-w-lg space-y-5">
            ...
            <div>
                ...
                <input id="form" wire:model="form" type="text" class="{{ $inputClass }}">
                <x-input-error :messages="$errors->get('form')" class="mt-2" />
            </div>
            <div>
                <label for="strength" class="{{ $labelClass }}">Strength (optional)</label>
                <input id="strength" wire:model="strength" type="text" class="{{ $inputClass }}">
