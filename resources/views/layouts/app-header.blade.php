    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="flex items-center gap-2 xl:hidden">
                <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-500 text-sm font-bold text-white">N</span>
                <span class="text-lg font-semibold text-gray-800 dark:text-white/90">NESIHA</span>
            </a>
