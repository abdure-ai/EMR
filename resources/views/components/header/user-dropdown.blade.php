<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="mr-3 flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-brand-500 font-medium text-white">
    ...
    >
        ...
        <div>
            ...
            @if (auth()->user()->roles->isNotEmpty())
                <span class="mt-0.5 block text-theme-xs text-gray-400">{{ auth()->user()->roles->pluck('name')->join(', ') }}</span>
            @endif
        </div>
