...
<div>
    <x-common.page-breadcrumb pageTitle="New Investigation" />

    <x-common.component-card title="New Investigation">
        <form wire:submit="save" class="max-w-lg space-y-5">
            ...
            <div>
                ...
                <input id="subcategory" wire:model="subcategory" type="text" placeholder="e.g. Hematology" class="{{ $inputClass }}">
                <x-input-error :messages="$errors->get('subcategory')" class="mt-2" />
            </div>
            <div>
                <label for="name" class="{{ $labelClass }}">Name</label>
                <input id="name" wire:model="name" type="text" placeholder="e.g. Complete Blood Count (CBC)" class="{{ $inputClass }}">
            ...
            <div class="flex justify-end gap-3">
                ...
                <x-ui.button type="submit">{{ __('Create Investigation') }}</x-ui.button>
            </div>
        </form>
